...
<body>
	...
	<div align="center">
		...
		<jsp:useBean id="meat2" class="code.util.Meat" scope="request">
			...
			<%-- HTTP Status 500 - Can't find a method to write property 'roasted' of type 'boolean' --%>
			<jsp:setProperty name="meat2" property="roasted" param="roasted" />
			<%-- HTTP Status 500 - Can't find a method to write property 'roasted' of type 'boolean' --%>
		</jsp:useBean>
		1. 我喜歡: <jsp:getProperty property="title" name="meat2"/>
			調理: <jsp:getProperty property="roasted" name="meat2"/><br><br>
