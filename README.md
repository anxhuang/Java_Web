...
S211: getServletContext().getInitParameter() and setting <context-param> in web.xml //global variables  
j211: Expression Language(EL) ${} => math operation, condition operation, empty check  
S212: getServletConfig().getInitParameter()  and setting <servlet> <servlet-mapping> in web.xml //servlet variables  
