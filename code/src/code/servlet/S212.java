 ...
 */
@WebServlet("/S212N") //<--- cannot be same as servlet mapping  
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		out.println("<h2>ServletConfig, S212</h2><h3>");
		out.println("Day 1: "+getServletConfig().getInitParameter("Day1")+"<br>");//method chaining
		out.println("Day 2: "+getServletConfig().getInitParameter("Day2")+"<br>");		
		out.println("</h2></h3></div></center>");
	}
