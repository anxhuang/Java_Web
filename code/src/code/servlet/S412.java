...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		out.println("<h2>Servlet/Request, S412</h2><h3><font color='blue'><table><tr><td colspan='2'>ServerInfo:</td></tr>");
		...
		out.println("<tr><td>getServerPort(): </td><td>"+serverPort+"</td></tr></table></font>");
		out.println("<font color='red'><table><tr><td colspan='2'>ClientInfo:</td></tr>");
